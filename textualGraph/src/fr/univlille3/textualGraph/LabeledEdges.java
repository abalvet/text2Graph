...
public class LabeledEdges {
    ...
    public static void main(String[] args) {
        ...
        // John is everyone's friend, but he can't be his own friend because we're using a MultiGraph

        for(int i = 1; i < people.size(); i++){
        	graph.addVertex(people.get(i));
            graph.addEdge(people.get(0), people.get(i), new RelationshipEdge<String>(people.get(0), people.get(i), friend));
        }
